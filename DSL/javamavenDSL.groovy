job('Java-Maven-App-DSL-v5') {
    ...
    steps {
        ...
        shell('''
          echo "Entrega 5: Desplegando la aplicación"
          java -jar "/var/jenkins_home/workspace/java-app-con-maven-git-jose-b-v5/target/my-app-1.0-SNAPSHOT.jar"
        ''') 
    }
    publishers {
